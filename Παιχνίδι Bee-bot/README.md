...
> [!NOTE]
>Η υλοποίηση βασίστηκε στο εξαιρετικό έργο Scratch  [Bee-Bot Simulation](https://scratch.mit.edu/projects/55987596) του [ivan321](https://scratch.mit.edu/users/ivan321/)
...
Εναλλακτικά, μπορείτε να κατεβάσετε το αρχείο [Παιχνίδι Bee-Bot.sb3](Παιχνίδι%20Bee-Bot.sb3) και να το φορτώσετε στο πρόγραμμα Scratch 3 στον υπολογιστή σας.
